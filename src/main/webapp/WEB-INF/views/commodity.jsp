                ...
                layui.use('table', function() {
                    ...
                    table.render({
                        ...
                        cols: [[
                            ...
                            {field: 'com_id',title: 'ID',width: 100, fixed: 'left'},
                            {field: 'com_name',title: '商品名称',width: 150},
                            {field: 'com_price',title: '商品价格',width: 220},
                            {field: 'com_stock',title: '库存',width: 250},
                            {field: 'com_information',title: '商品描述',width: 160},
